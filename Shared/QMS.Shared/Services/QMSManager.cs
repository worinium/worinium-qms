...
namespace QMS.Shared.Services
{
    ...
    {
        #region Tablet-End
        public static string GetQmsService(string state)
        ...
        public static string getRegionTokens(string regionCode)
        ...
        public static string getCalledQueueTokens(string regionCode)
