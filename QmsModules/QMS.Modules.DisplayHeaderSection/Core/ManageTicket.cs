...
using QMS.Shared.Services;

namespace QMS.Module.DisplayHeaderSection.Core
{
    internal class ManageTicket
    {
        ...
        void pdoc_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            {
                throw new Exception($"ManageTicket.pdoc_PrintPage: {ex.Message} ");
            }
            finally
            {
                graphics.Dispose();
